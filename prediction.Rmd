...
This project will be attempting to predict stock price moving direction based on historical stock data. Historic data will be gathered from Yahoo Finance. Stock pricing data is extemly noisy and not an easy task to predict, therefore this project will just focus on general methods instead of results.
...
**Caution:** This step will take some time to run, depends on computer performance.
...
Total of (6) models will be trained:
